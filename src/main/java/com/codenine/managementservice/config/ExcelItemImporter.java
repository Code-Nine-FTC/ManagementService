...
public class ExcelItemImporter {
    ...
    @Transactional
    public void importItemTypesFromExcel(String excelPath, Long sectionId, User lastUser) throws Exception {
    ...
    @Transactional
    public void importItemsExcel(String excelPath, Long sectionId, User lastUser, SupplierCompany supplier)
            throws Exception {
        ...
        try (FileInputStream fis = new FileInputStream(excelPath);
            ...
            for (Row row : sheet) {
                ...
                try {
                    ...
                    if (itemName == null || itemName.isEmpty() || qtd == null || apres == null || apres.isEmpty()) {
                        System.err.println(
