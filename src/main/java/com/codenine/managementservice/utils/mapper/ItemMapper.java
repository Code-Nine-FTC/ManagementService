...
public class ItemMapper {
  public static Item toEntity(ItemRequest dto, User lastUser, ItemType itemType) {
    Item item = new Item();
  ...
  public static void updateEntity(Item item, ItemRequest dto, User lastUser, ItemType itemType) {
    if (dto.name() != null) item.setName(dto.name());
    if (dto.itemCode() != null) item.setItemCode(dto.itemCode());
