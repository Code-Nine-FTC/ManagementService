...
public class ItemService {
    ...
    public ItemResponse getItem(Long id) {
        getItemById(id);
        return itemRepository.findAllItemResponses(null, null, null, null, null, id).stream().findFirst().orElse(null);
    }
    ...
    public void updateItem(Long id, ItemRequest itemRequest, User lastUser) {
        ...
        if (itemRequest.itemTypeId() != null) {
            itemType = itemTypeRepository.findById(itemRequest.itemTypeId())
                    .orElseThrow(
                            () -> new NullPointerException("ItemType not found with id: " + itemRequest.itemTypeId()));
        }
