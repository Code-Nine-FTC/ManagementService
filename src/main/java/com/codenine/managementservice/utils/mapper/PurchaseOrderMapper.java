...
public class PurchaseOrderMapper {
    ...
    public static PurchaseOrder toEntity(PurchaseOrderRequest request, User lastUser, Order order, SupplierCompany supplierCompany) {
    ...
    public static void updateEntity(PurchaseOrder purchaseOrder, PurchaseOrderRequest request, User lastUser, Order order, SupplierCompany supplierCompany) {
