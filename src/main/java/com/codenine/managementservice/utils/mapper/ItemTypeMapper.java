...
public class ItemTypeMapper {
  ...
  public static void updateEntity(
      ItemType itemType, ItemTypeRequest request, Section section, User lastUser) {
    if (request.name() != null) itemType.setName(request.name());
    if (section != null) itemType.setSection(section);
