...
public class ItemMapper {
  public static Item toEntity(
      ItemRequest dto, User lastUser, SupplierCompany supplier, ItemType itemType) {
    Item item = new Item();
  ...
  public static void updateEntity(
      Item item, ItemRequest dto, User lastUser, SupplierCompany supplier, ItemType itemType) {
