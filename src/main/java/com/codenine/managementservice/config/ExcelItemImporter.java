    ...
    try (FileInputStream fis = new FileInputStream(excelPath);
      ...
      for (Row row : sheet) {
        ...
        try {
          ...
          Item existingItem =
              itemRepository.findByNameAndItemTypeSectionId(itemName, section.getId()).orElse(null);
          ...
          if (existingItem != null) {
            try {
              ...
              int total =
                  lotRepository.findByItemOrderByExpireDateAscCreatedAtAsc(existingItem).stream()
