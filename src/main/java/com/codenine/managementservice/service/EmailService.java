...
public class EmailService {
    ...
    public void sendCommitmentNoteEmail(PurchaseOrder po, SupplierCompany supplier, String toEmail) {
        ...
        po.getCommitmentNoteNumber(), po.getCreatedAt().toLocalDate(),
        po.getCommitmentNoteNumber(), po.getCreatedAt().toLocalDate(),
        supplier.getName(), supplier.getCnpj(),
    ...
    private void checkLateDeliveries() {
        ...
        List<PurchaseOrder> lateOrders = purchaseOrderRepository.findPendingOrdersOlderThan(thirtyDaysAgo);
